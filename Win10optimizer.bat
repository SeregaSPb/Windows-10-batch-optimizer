...
NETSH advfirewall firewall add rule name="telemetry_deploy.static.akamaitechnolo.." dir=out action=block remoteip=23.218.212.69 enable=yes
...
NETSH advfirewall firewall add rule name="telemetry_ads1.msn.com" dir=out action=block remoteip=8.12.207.125 enable=yes
